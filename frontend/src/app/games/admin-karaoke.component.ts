  ...
  template: `
    <div class="admin-container">
      <div class="header">
        ...
        <button class="btn-primary" (click)="showForm = true">+ Ajouter une chanson</button>
      </div>
        ...
        <div class="modal">
          <div class="modal-content">
            ...
            <div class="form-group checkbox">
              ...
              <label for="published">Publier la chanson</label>
            </div>
...
export class AdminKaraokeComponent implements OnInit {
  ...
  resetSong(): KaraokeSong {
    return { title: '', artist: '', audioUrl: '', lyricsJson: '[]', published: false };
  }
  ...
  generateWithAI() {
    ...
    this.service.generateLyrics(this.currentSong.title, this.currentSong.artist).subscribe({
      next: (res) => {
        try {
          // Extract the JSON array from the response string if needed
